"""Regression checks for the lumen-mob-prefs-index casebook."""
...
from casebook.harness import assert_expected, lumen_mob_prefs_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lumen_mob_prefs_index_summary(), assert_expected())
