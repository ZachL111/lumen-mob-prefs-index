...
lumen-mob-prefs-index is a Go project for mobile workflows. It focuses on this technical goal: Create a Go reference implementation for prefs workflows, centered on state machine modeling, transition tables, and invalid-transition tests.
